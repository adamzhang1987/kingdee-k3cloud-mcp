...
```
金蝶MCP Server（Kingdee K3Cloud MCP）面向金蝶云星空 ERP。让 Claude Desktop、Cursor、Cline、Cherry Studio 等任意支持 MCP 协议的 AI 客户端，通过自然语言直接查询和操作金蝶 ERP 系统。
...
```
Kingdee K3Cloud MCP Server (金蝶MCP) for 金蝶云星空 — one of China's most widely adopted ERP systems.
...
| 用途 | 链接 |
|------|------|
| 金蝶MCP 官网 | https://adamzhang1987.github.io/kingdee-k3cloud-mcp/ |
